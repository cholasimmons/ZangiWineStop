    ...
    class KCartEx extends KCart{
        ...
        function get_shipping(){
            ...
            foreach( $this->items as $key=>$item ){
                $scale_line_quantity = trim( $item['delivery_scale'] );
                if( $item['requires_delivery'] && strlen($scale_line_quantity) ){
